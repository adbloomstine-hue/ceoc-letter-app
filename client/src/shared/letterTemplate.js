...
export function generateLetterContent({ fullName, company, address, city, zip, assemblyMember, senator, signatureImage, date }) {
  ...
  return '<style>'
    ...
    + '<p>As an employee owner in the construction industry, this bill would allow me, my co-workers, and thousands of other employee owners in California to access wealth-building advantages that have historically been limited to company executives.</p>'
