...
export function generateLetterContent({ fullName, company, address, city, zip, assemblyMember, senator, signatureImage, date }) {
  ...
  return '<style>'
    ...
    + '<p>I believe the state should invest taxpayer dollars in companies that give employee owners across the state access to wealth-building opportunities that have historically been limited to company executives.</p>'
