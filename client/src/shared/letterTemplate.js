...
export function generateLetterContent({ fullName, company, address, city, zip, assemblyMember, senator, signatureImage, date }) {
  ...
  return '<style>'
    ...
    + 'The Honorable Suzette Valladares<br>'
    ...
    + '<div class="content">'
    + '<p>I am writing to express my strong support for Senate Bill 1174, which creates a contracting preference for construction companies that operate an employee stock ownership plan (ESOP). I believe that fostering employee ownership is crucial for building a stronger, more equitable, and sustainable local economy.</p>'
    ...
    + '<p>As an employee owner in the construction industry in California, this bill would allow me, my co-workers and thousands of other employee owners in California to experience the benefits and advantages previously provided to the few company owners who qualified for a DBE or similar program.</p>'
